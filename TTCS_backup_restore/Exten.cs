...
namespace TTCS_backup_restore
{
    public static class Exten
    {
        public static DialogResult ShowInputDialogBox(ref string input, string prompt, string title = "Title", int width = 200, int height = 100)
        {
            ...
            inputBox.Text = title;
            inputBox.Font = new Font("Arial", (float)12.0, FontStyle.Bold);
            ...
            okButton.Text = "&OK";
            okButton.Location = new Point((int)(size.Width - 75 * 2 - 30) / 2, size.Height - 40);
            ...
            cancelButton.Location = new Point((int)(size.Width - 75 * 2 - 30) / 2 + 30 + 75, size.Height - 40);
